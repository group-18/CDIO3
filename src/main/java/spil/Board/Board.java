...
public class Board {
    ...
    private Field[] createFields()
    {
        return new Field[] {
            ...
            new HouseField(Translate.t("board.field.start.title"), "2"),
            new HouseField(Translate.t("board.field.start.title"), "2"),
            new ChanceField(),
            new HouseField(Translate.t("board.field.start.title"), "2"),
            new HouseField(Translate.t("board.field.start.title"), "2"),
            new ParkingField(),
            new HouseField(Translate.t("board.field.start.title"), "3"),
            new HouseField(Translate.t("board.field.start.title"), "3"),
            new ChanceField(),
            new HouseField(Translate.t("board.field.start.title"), "3"),
            new HouseField(Translate.t("board.field.start.title"), "3"),
            new PrisonField(false),
            new HouseField(Translate.t("board.field.start.title"), "4"),
            new HouseField(Translate.t("board.field.start.title"), "4"),
            new ChanceField(),
            new HouseField(Translate.t("board.field.start.title"), "5"),
            new HouseField(Translate.t("board.field.start.title"), "5"),
        };
    }
