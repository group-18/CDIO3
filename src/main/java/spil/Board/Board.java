...
public class Board {
    ...
    private Field[] createFields()
    {
        return new Field[] {
            ...
            new ChanceField() .setTitle("Chance").setSubText("?"),
            new HouseField(Translate.t("board.field.skaterparken.description"), 2, Color.orange).setSubText("M3"),
            new HouseField(Translate.t("board.field.swimmingpoolen.description"), 2, Color.orange).setSubText("M3"),
            new ParkingField() .setTitle("Parkering").setSubText("?"),
            new HouseField(Translate.t("board.field.spillehallen.description"), 3, Color.red).setSubText("M3"),
            new HouseField(Translate.t("board.field.biografen.description"), 3, Color.red).setSubText("M3"),
            new ChanceField() .setTitle("Chance").setSubText("?"),
